...
##draw the graph on topright
plot(m$date_time,m$Voltage,type="l",ylab="Voltage",xlab="datetime")
lines(m$date_time,m$Voltage)
##draw the graph on bottomright
plot(m$date_time,m$Global_reactive_power,type="l",ylab="Global_reactive_power",xlab="datetime")
lines(m$date_time,m$Global_reactive_power)
dev.off()
